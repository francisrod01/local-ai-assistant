...
export function Header() {
  return (
    <header className="sticky top-0 z-50 bg-gray-900 text-white py-2 px-4 shadow-lg">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-lg bg-linear-to-br from-indigo-400 via-purple-500 to-fuchsia-500 px-3 py-1">
