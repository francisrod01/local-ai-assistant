    ...
    <main className="relative flex items-center justify-center min-h-screen">
      <div className="flex flex-col items-center gap-12">
        <header className="flex flex-col items-center gap-4">
          <div className="w-75 max-w-[80vw] p-4">
          ...
          <p className="text-center max-w-125 text-gray-700 dark:text-gray-300">
            Chat offline on your device using OpenSource models.
            <br />
            <span className="mt-2 block text-gray-600 dark:text-gray-400">Using the local Ollama model stack (llama3.2:3b by default) today, with more options planned.</span>
          </p>
        </header>
        ...
        <div className="space-y-4">
          ...
          <p className="mt-6 text-sm text-gray-600 max-w-100">
